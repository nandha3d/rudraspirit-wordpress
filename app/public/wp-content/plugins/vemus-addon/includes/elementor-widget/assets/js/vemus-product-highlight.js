(function ($) {
  ...
  var initProductHighLight = function ($scope) {
    var $scope = $scope;
    swiper($scope);
    videoPopup($scope);
    // countDown($scope);
  ...
  /* Video Popup 
    -------------------------------------------------------------------------*/
  var videoPopup = function (container) {
    if ($("div", container).hasClass("video-wrap")) {
  ...
  $(window).on('elementor/frontend/init', function () {
    elementorFrontend.hooks.addAction('frontend/element_ready/vemus_product_highlight.default', initProductHighLight);
  });
