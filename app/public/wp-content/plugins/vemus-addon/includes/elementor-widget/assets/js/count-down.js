...
(function () {
    ...
    var initializeCountDowns = function(container = document){
        //initialize the CountDown objects
        /*        window.setTimeout(() => {*/
        var countDown = container.getElementsByClassName("js-countdown-core");
        if (countDown.length > 0) {
            for (var i = 0; i < countDown.length; i++) {
                (function (i) {
                    if (!countDown[i].getElementsByClassName("countdown__timer").length) {
