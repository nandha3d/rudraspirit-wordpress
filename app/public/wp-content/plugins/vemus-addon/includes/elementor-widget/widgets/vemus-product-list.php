...
class Vemus_Product_List extends \Elementor\Widget_Base {
	...
	protected function render(): void
	{
		...
		$product_list_classes = "wrapper-shop";
		...
		if($has_add_to_cart_btn && $button_icon){
			...
			$product_list_classes .= ' add-to-cart-hidden';
		}

		if( $has_carousel ){
			$product_list_classes .= " swiper-wrapper";
			$carousel_configs = TFWC_Elementor_Widget_Addon::get_carousel_configs($this);
		}else{
			$product_list_classes .= " tf-list-layout";
		}
