<?php
/**
 * Elementor Vemus Product List Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Vemus_Product_List extends \Elementor\Widget_Base {
	 ...
	 * Get widget name.
	 *
	 * Retrieve Vemus Product List widget name.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_name() {
		return 'vemus_product_list';
	}

	/**
	 * Get widget title.
	 *
	 * Retrieve Vemus Product List widget title.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_title() {
		return esc_html__( 'Vemus Product List', 'vemus-addon' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Vemus Product List widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Retrieve the list of categories the Vemus Product List widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 * Get widget keywords.
	 *
	 * Retrieve the list of keywords the Vemus Product List widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	...
	{
		return ['list-elementor-widget', 'list', 'tf-list', 'vemus-product-list' , 'vemus-list', 'tf', 'vemus'];
	}
	...
	/**
	 * Register Vemus Product List widget controls.
	 *
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_setting',
			[
				'label' => esc_html__('Vemus Product List', 'vemus-addon'),
			]
		);
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .banner-list > img' => 'height: {{SIZE}}{{UNIT}} !important;',
		// 		],
		// 		'separator'  => 'before',
		// 	]
		// );
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .flat-wrapper-list' => 'flex-direction: {{VALUE}};',
		// 		],
		// 	]
		// );
		...
		$this->add_control(
			'heading_lb_title',
			[
				'label' => esc_html__( 'List title', 'vemus-addon' ),
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .flat-wrapper-list .col-right' => 'width: {{SIZE}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 		'size_units' => [ 'px', '%' ],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .banner-list' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product' => 'background-color: {{VALUE}};',
		// 		],
		// 	]
		// );	
		...
		// 		'size_units' => [ 'px', 'em', '%' ],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 		'size_units' => [ 'px', '%' ],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .img-style' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; max-width: unset;',
		// 		],
		// 	]
		// );
		...
		// 		'size_units' => [ 'px', '%' ],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .img-style' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 	[
		// 		'name' => 'name_typography',
		// 		'selector' => '{{WRAPPER}} .tf-list .loobook-product .name-product',
		// 	]
		// );
		...
		// 		'type' => \Elementor\Controls_Manager::COLOR,
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .name-product' => 'color: {{VALUE}};',
		// 		],
		// 	]
		// );	
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .wrap-name' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 	[
		// 		'name' => 'price_typography',
		// 		'selector' => '{{WRAPPER}} .tf-list .loobook-product .price-wrap',
		// 	]
		// );
		...
		// 		'type' => \Elementor\Controls_Manager::COLOR,
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .price-wrap' => 'color: {{VALUE}};',
		// 		],
		// 	]
		// );	
		...
		// 		'type' => \Elementor\Controls_Manager::COLOR,
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .price-wrap del' => 'color: {{VALUE}};',
		// 		],
		// 	]
		// );
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .tf_quickview_btn' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .tf_quickview_btn' => 'font-size: {{SIZE}}{{UNIT}};',
		// 		],
		// 	]
		// );
		...
		// 		'size_units' => [ 'px', '%', 'em' ],
		// 		'selectors'  => [
		// 			'{{WRAPPER}} .tf-list .loobook-product .tf_quickview_btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
		// 		],
		// 	]
		// );
		...
		// 			'type' => \Elementor\Controls_Manager::COLOR,
		// 			'selectors' => [
		// 				'{{WRAPPER}} .tf-list .loobook-product .tf_quickview_btn' => 'color: {{VALUE}};',
		// 			],
		// 		]
		// 	);	
		...
		// 			'type' => \Elementor\Controls_Manager::COLOR,
		// 			'selectors' => [
		// 				'{{WRAPPER}} .tf-list .loobook-product .tf_quickview_btn' => 'background-color: {{VALUE}};',
		// 			],
		// 		]
		// 	);	
		...
		// 			'type' => \Elementor\Controls_Manager::COLOR,
		// 			'selectors' => [
		// 				'{{WRAPPER}} .tf-list .loobook-product .tf_quickview_btn:hover' => 'color: {{VALUE}};',
		// 			],
		// 		]
		// 	);	
		...
		// 			'type' => \Elementor\Controls_Manager::COLOR,
		// 			'selectors' => [
		// 				'{{WRAPPER}} .tf-list .loobook-product .tf_quickview_btn:hover' => 'background-color: {{VALUE}};',
		// 			],
		// 		]
		// 	);
	...
	/**
	 * Render Vemus Product List widget output on the frontend.
	 *
	...
	<div class="tf-mini-cart-main wrapper-leave-main">
		<div class="tf-mini-cart-sroll wrapper-leave-scroll p-0">
