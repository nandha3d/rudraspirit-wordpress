        ...
        ?>
    <!-- Icon Box -->
        <div class="flat-spacing-8 bg-dark-tan widget-icon-box">
            <div class="container">
                <div class="tf-swiper tfc-swiper swiper sw-iconbox" data-preview="<?php echo esc_attr($slides_per_view_xl); ?>" data-tablet="<?php echo esc_attr($slides_per_view_md); ?>" data-mobile-sm="<?php echo esc_attr($slides_per_view_sm); ?>" data-mobile="<?php echo esc_attr($slides_per_view_xs); ?>" data-space-lg="<?php echo esc_attr($space_between_desktop); ?>"
