        ...
        <div class="tf-slideshow">
            <div dir="ltr" class="swiper tf-swiper tfc-swiper sw-slide-show slider_effect_fade-md" data-preview="2" data-tablet="2" data-mobile-sm="1"
                data-mobile="1" data-pagination="1" data-pagination-sm="1" data-pagination-md="2" data-pagination-lg="2">
                    ...
                    <div class="swiper-slide">
                        <div class="slider_wrap elementor-repeater-item-<?php echo esc_attr($slider['_id']);?>_content">
                            ...
                            <div class="sld-content">
                                <div class="container">
                                    <div class="content-sld text-center wow fadeInUp">
                                        ...
                                        <?php if ( $slider['button2_text'] ) : ?>
                                            <div class="fade-item fade-item-3">
                                                <a href="<?php echo esc_attr($slider['link_button2']['url']); ?>" class="tf-btn btn-fill-white-2">
