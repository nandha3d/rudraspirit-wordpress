        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-top">
                    ...
                    <h3 class="title fw-normal text-uppercase"><?php esc_html_e( 'Log in', 'vemus-addon' ); ?></h3>
                </div>
                <div class="modal-bottom">
                    <form id="tfwc_custom_login_form" method="post" enctype="multipart/form-data" class="tfwc-custom-login-form form-login form-log">
                        <div class="form-content">
					        <div class="tfwc-message"></div>
                            <fieldset class="tf-field">
						        <input class="tf-input" type="text" name="username" class="" placeholder="<?php esc_html_e( 'Email or Username*', 'vemus-addon' ); ?>" required>
                                <label class="tf-lable"><?php esc_html_e( 'Username *', 'vemus-addon' ); ?></label>
                            </fieldset>
                            <fieldset class="tf-field password-wrapper">
						        <input class="tf-input password-field" type="password" id="password"  name="password" placeholder="<?php esc_html_e( 'Password*', 'vemus-addon' ); ?>" required>
                        ...
                        <div class="bottom">
							<div class="checkbox-wrap">
								<input id="remember" type="checkbox" class="tf-check" name="remember" value="1">
								<label for="remember"><?php esc_html_e( 'Remember me', 'vemus-addon' ); ?></label>
							</div>
					        <a href="#reset" data-bs-toggle="offcanvas" class="link"><?php esc_html_e( 'Forgot password?', 'vemus-addon' ); ?></a>
                        </div>
                        <button class="subscribe-button btn-submit tf-btn btn-fill-2 w-100"
							type="submit"><?php esc_html_e( 'LOG IN', 'vemus-addon' ); ?>
                        </button>
                    </form>
                    ...
                    <div class="text-center">
                        <a href="#register" data-bs-toggle="modal" class="tf-btn-line tf-login-form">
                            <?php esc_html_e( 'New customer? Create your account', 'vemus-addon' ); ?>
