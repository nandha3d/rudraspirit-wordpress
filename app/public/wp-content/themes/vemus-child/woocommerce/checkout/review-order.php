<?php
/**
 * Review order table (Child Theme Override)
 *
...
<div class="shop_table woocommerce-checkout-review-order-table">
	...
	<ul class="list-total text-uppercase">
		...
		<?php if ( wc_coupons_enabled() ) : ?>
			<li class="checkout-coupon-sidebar-row" style="list-style: none; padding: 14px 0; border-bottom: 1px solid rgba(0,0,0,0.08); width: 100%;">
				<div class="wrap-coupon-sidebar">
					<div class="checkout_coupon woocommerce-form-coupon sidebar-coupon-form" style="display: flex; gap: 8px; width: 100%; margin: 0;">
						<input type="text" name="coupon_code" class="input-text" id="checkout_sidebar_coupon_code" value="" placeholder="<?php esc_attr_e( 'Discount code', 'vemus' ); ?>" style="flex: 1; height: 42px; border: 1px solid #ddd; border-radius: 6px; padding: 0 12px; font-size: 13px; background: #fff; color: #191410;" />
						<button type="button" class="button tf-btn apply-checkout-coupon-btn" style="height: 42px; padding: 0 16px; border-radius: 6px; font-weight: 600; background: #191410; color: #fff; border: none; cursor: pointer; font-size: 13px; text-transform: uppercase;"><?php esc_html_e( 'Apply', 'vemus' ); ?></button>
					</div>
				</div>
			</li>
		<?php endif; ?>
