								...
								<tbody>
									...
									<tr>
										<td colspan="6" class="actions">
											<div class="wrap-coupon" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px; width: 100%;">
												<a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" class="button continue-shopping tf-btn btn-out-line-dark-2 fw-medium animate-btn" style="display: inline-flex; align-items: center; justify-content: center; height: 46px; padding: 0 24px; border-radius: 6px; font-weight: 600; text-decoration: none; border: 2px solid #191410; color: #191410;">
													<?php esc_html_e( 'Continue Shopping', 'vemus' ); ?>
												</a>
												<button type="submit" class="button tf-btn radius-6 btn-out-line-dark-2 tf-update-cart-btn" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'vemus' ); ?>" style="height: 46px; padding: 0 24px; border-radius: 6px; font-weight: 600; background: #191410; color: #fff; border: none; cursor: pointer;"><?php esc_html_e( 'Update cart', 'vemus' ); ?></button>
											</div>
