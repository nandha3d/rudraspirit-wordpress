                    ...
                    <div class="toolbar-item">
                        <a href="<?php echo esc_url( wc_get_page_permalink( 'wishlist' ) ); ?>">
                            <div class="toolbar-icon nav-icon-item wishlist-btn-fragment">
                                ...
                                <div class="toolbar-count count-box"><?php echo esc_html( $wishlist_count ); ?></div>
                            </div>
                            <div class="toolbar-label"><?php echo _e('Wishlist','vemus')?></div>
                        </a>
                    </div>
                    <?php
                    }
            } elseif ( 'cart' == $content_element ) {
                
                if ( class_exists( 'woocommerce' ) ) { ?>
                    <div class="toolbar-item nav-cart">
                        <a href="<?php echo esc_url( wc_get_page_permalink( 'cart' ) ); ?>" data-bs-toggle="offcanvas" data-bs-target="#shoppingCart" class="nav-icon-item">
                            <div class="toolbar-icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.70906 7.42985L4.0424 16.699H15.8641L15.1974 7.42985H4.70906ZM16.7491 5.76318H3.15823L2.38073 16.5798C2.36436 16.8082 2.39521 17.0374 2.47134 17.2533C2.54748 17.4692 2.66727 17.6671 2.82325 17.8347C2.97923 18.0022 3.16805 18.1358 3.37795 18.2272C3.58785 18.3186 3.81431 18.3657 4.04323 18.3657H15.8641C16.0931 18.3657 16.3196 18.3185 16.5296 18.2271C16.7395 18.1357 16.9284 18.002 17.0844 17.8344C17.2404 17.6667 17.3601 17.4687 17.4362 17.2527C17.5123 17.0368 17.5431 16.8074 17.5266 16.579L16.7491 5.76318Z" fill="black"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.38996 3.86652C9.17153 3.86641 8.95523 3.90936 8.75342 3.99292C8.55162 4.07649 8.36826 4.19901 8.21385 4.3535C8.05944 4.50799 7.93701 4.6914 7.85355 4.89325C7.77009 5.0951 7.72724 5.31143 7.72746 5.52985V6.10068C7.72746 6.3217 7.63966 6.53366 7.48338 6.68994C7.3271 6.84622 7.11514 6.93402 6.89412 6.93402C6.67311 6.93402 6.46115 6.84622 6.30487 6.68994C6.14859 6.53366 6.06079 6.3217 6.06079 6.10068V5.52985C6.06068 5.09263 6.14672 4.65967 6.31399 4.2557C6.48125 3.85174 6.72647 3.48469 7.03564 3.17553C7.3448 2.86637 7.71185 2.62115 8.11581 2.45388C8.51977 2.28661 8.95273 2.20057 9.38996 2.20068H10.5275C11.412 2.2009 12.2603 2.55246 12.8857 3.17802C13.5111 3.80359 13.8625 4.65194 13.8625 5.53652V6.10068C13.8625 6.3217 13.7747 6.53366 13.6184 6.68994C13.4621 6.84622 13.2501 6.93402 13.0291 6.93402C12.8081 6.93402 12.5961 6.84622 12.4399 6.68994C12.2836 6.53366 12.1958 6.3217 12.1958 6.10068V5.53652C12.1958 5.09397 12.02 4.66954 11.7072 4.35653C11.3943 4.04353 10.97 3.86757 10.5275 3.86735" fill="black"></path>
                                </svg>

                                <?php if ( $items_count = WC()->cart->get_cart_contents_count() ): ?>
                                    <div class="toolbar-count count-box shopping-cart-items-count"><?php echo esc_html( $items_count ) ?></div>
                                <?php else: ?>
                                    <div class="toolbar-count count-box shopping-cart-items-count">0</div>
                                <?php endif ?>
                            </div>
                            <div class="toolbar-label"><?php echo _e('Cart','vemus')?></div>
                        </a>
                    </div>
