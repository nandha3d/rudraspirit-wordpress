...
?>
<div class="tf-shop-control style-2 mb_10">
    <div class="container">
        <div class="row align-items-center row-shop-control">
            <div class="col-3">
                <div class="tf-control-filter justify-content-between pe-xxl-30">
                    ...
                    <?php } ?>
                    <button id="reset-filter" class="btn-check-none remove-all-filters">
                        <span class="text-body"><?php echo esc_html__('Clear all','vemus')?></span>
                    </button>
                </div>
            </div>
            <div class="col-9">
                <div class="tf-group-layout justify-content-end">
                    <div id="product-count-grid" class="count-text-total tf-hidden-xl-max">
                    ...
                    <?php if(themesflat_get_opt('catalog_sort_by') == 1) { ?>
                        <div class="tf-dropdown-sort" data-bs-toggle="dropdown">
                            <div class="btn-select">
                                <span class="text-sort-value"><?php _e('Alphabetically, A-Z', 'vemus'); ?></span>
                                <span class="icon icon-arrow-angle-down"></span>
                            </div>
                            <div class="dropdown-menu">
                                <div class="select-item" data-sort-value="best-selling">
                                    <span class="text-value-item"><?php _e('Best selling', 'vemus'); ?></span>
                                </div>
                                <div class="select-item active" data-sort-value="a-z">
                                    <span class="text-value-item"><?php _e('Alphabetically, A-Z', 'vemus'); ?></span>
                                </div>
                                <div class="select-item" data-sort-value="z-a">
                                    <span class="text-value-item"><?php _e('Alphabetically, Z-A', 'vemus'); ?></span>
                                </div>
                                <div class="select-item" data-sort-value="price-low-high">
                                    <span class="text-value-item"><?php _e('Price, low to high', 'vemus'); ?></span>
                                </div>
                                <div class="select-item" data-sort-value="price-high-low">
                                    <span class="text-value-item"><?php _e('Price, high to low', 'vemus'); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
    ...
    <div id="product-count-grid-mobile" class="count-text-total tf-hidden-xl-min">
        <?php echo sprintf( _n( 'A total of <span class="count-number">%s</span> result', 'A total of <span class="count-number">%s</span> results', $count ?? 0, 'vemus' ), number_format_i18n($count) ); ?>
    </div>
</div>