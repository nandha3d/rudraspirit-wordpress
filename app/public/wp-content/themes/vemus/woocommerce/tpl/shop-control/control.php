...
?>
<div class="tf-shop-control <?php echo esc_attr(themesflat_get_opt('show_top_category') == 1 ? 'has-top-category' : 'no-top-category'); ?>">
    <div class="tf-control-filter">
        ...
        <div class="offcanvas offcanvas-start canvas-sidebar canvas-filter tf-filter-sidebar-shop" id="filterShop" aria-modal="true" role="dialog">
            <div class="canvas-wrapper">
                <div class="canvas-header">
                    <span class="title"><?php echo esc_html__('FILTER','vemus')?></span>
                    <div class="icon-close link icon-close-popup" data-bs-dismiss="offcanvas" aria-label="Close"></div>
                </div>
        ...
        <div class="meta-filter-shop">
            ...
            <button id="reset-filter" class="btn-check-none remove-all-filters">
                <span class="text-body"><?php _e('Clear all', 'vemus'); ?></span>
            </button>
        </div>
    </div>
