...
remove_action( 'woocommerce_before_shop_loop_item_title', 'tfwc_class_wrap_btn_close' ,50);

remove_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_add_to_cart', 72 );
