...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="form-checkout-sidebar">
		<div class="form-content" >
			...
			<!-- <h2 class="total-discount text-xl fw-medium"><?php //esc_html_e( 'Cart totals', 'vemus' ); ?></h2> -->
			<!-- <div class="title-total h4">
				<span><?php esc_html_e( 'Total:', 'vemus' ); ?></span>
				<span class="each-total-price"><?php wc_cart_totals_order_total_html(); ?></span>
			</div> -->
			...
			<div class="checkbox-wrap">
				<input id="agree-term" type="checkbox" class="tf-check style-4" required=true>
				<label for="agree-term">I argee Terms and conditions</label>
			</div>

			<div class="wc-proceed-to-checkout draw-border checkout-btn">
				<?php //do_action( 'woocommerce_proceed_to_checkout' ); ?>
				<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button alt wc-forward tf-btn btn-fill fw-medium animate-btn w-100">
