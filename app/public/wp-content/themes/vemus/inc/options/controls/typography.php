...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'vemus' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'vemus' ),
				'200'        => esc_html__( 'Extra-light 200', 'vemus' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'vemus' ),
				'300'        => esc_html__( 'Light 300', 'vemus' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'vemus' ),
				'400'        => esc_html__( 'Normal 400', 'vemus' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'vemus' ),
				'regular'    => esc_html__( 'Normal 400', 'vemus' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'vemus' ),
				'500'        => esc_html__( 'Medium 500', 'vemus' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'vemus' ),
				'600'        => esc_html__( 'Semi-bold 600', 'vemus' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'vemus' ),
				'700'        => esc_html__( 'Bold 700', 'vemus' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'vemus' ),
				'800'        => esc_html__( 'Extra-bold 800', 'vemus' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'vemus' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'vemus' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'vemus' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'vemus'),
			    "greek" 		=> esc_html__("Greek",'vemus'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'vemus'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'vemus'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'vemus'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'vemus'),
			    "latin" 		=> esc_html__("Latin",'vemus')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'vemus' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'vemus' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'vemus' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'vemus' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'vemus' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'vemus' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'vemus' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'vemus' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
