...
if (class_exists('WP_Customize_Control')) {
    class Themesflat_Repeater2_Controls extends WP_Customize_Control {
            ...
            <li id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($class); ?>">
                        ...
                        <?php if (!empty($json)) :
                            foreach ($json as $index => $item) :
                                ...
                                <li class="repeater-item">
                                    ...
                                    <input type="text" class="repeater-btn-text" value="<?php echo esc_attr($btn_text); ?>" placeholder="<?php esc_attr_e('Enter button text...', 'vemus'); ?>" />
                ...
                <script type="text/html" class="tmpl-repeater-item">
                    <li class="repeater-item">
                        ...
                        <input type="text" class="repeater-btn-text" placeholder="<?php esc_attr_e('Enter button text...', 'vemus'); ?>" />
                        <button type="button" class="button-secondary remove-repeater-item"><?php esc_html_e('Remove', 'vemus'); ?></button>
                    </li>
                </script>
            </li>
